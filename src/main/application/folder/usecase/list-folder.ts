...
// delegates the directory read to the FolderReader port. Returns the entries on success, or a typed
// FolderListingError on any problem. Listing is one level deep; the explorer re-lists to expand a
// subfolder.
...
export const listFolder = (
  ...
  Effect.gen(function* () {
    ...
    return yield* reader.listFolder(validPath)
  })
