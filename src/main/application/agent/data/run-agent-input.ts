...
// run state (effort, model). The runId is minted by the runtime, not the caller. This is the plain
// payload that crosses IPC; the agent's reply streams back as AG-UI events.
