// Tests for the FileSystem-backed FileWriter adapter's writeFile against a real temp directory.
// Verifies it overwrites an existing file, reports a missing target, and refuses to write a directory.
...
const run = (
  ...
  Effect.runPromiseExit(
    Effect.flatMap(FileWriter, (writer) => writer.writeFile(target, content)).pipe(
